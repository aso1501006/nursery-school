...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        drawCalendar();
        //drawTable($calendarElement, $tableObj,localStorage.getItem('year'),localStorage.getItem('month'));
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $currMonthLabel = $('<span class="span">' + year + '年  ' + monthLabels[month] + '</span>');
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var $dowElement = $('<td id="' + dateId + '" class="sche"></td>');
...
$.fn.zabuto_calendar_language = function (lang) {
    ...
    switch (lang.toLowerCase()) {
        case 'ja':
            return {
                month_labels: ["1がつ", "2がつ", "3がつ", "4がつ", "5がつ", "6がつ", "7がつ", "8がつ", "9がつ", "10がつ", "11がつ", "12がつ"],
                dow_labels: ["げつ", "か", "すい", "もく", "きん", "どう", "にち"]
            };
            break;
