...
<title>３６０°動画をアップロードする</title>
<script type="text/javascript" src="./js/360Upload.js"></script>

</head>
<body background="./img/back.jpg">
  <div id="wrapper">
    <!--３６０°動画をアップロードするフォームを作る-->
    <form action="" id="form1" method="post" enctype="multipart/form-data"> 
      <div class="center">
        <nobr><p><font size="10">３６０°ど～があっぷろ～ど</font></p></nobr>
          <img class="san" alt="" src="./img/Upload360Img.jpg"><br>
